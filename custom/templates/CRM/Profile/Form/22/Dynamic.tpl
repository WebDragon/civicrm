                        ...
                        <tr>
                          ...
                          {else}
                              ...
                              {if $count == $field.options_per_line}
                                  ...
                                  {if array_key_exists($key, $relatedFields)}
                                  {eval var=$relatedFields.$key assign='relN'}
                                  <tr id="relatedField-{$relN}" class="form-item subsection">
                                    <td>
                                        <div class="label">{$form.$relN.label}</div>
                                        <div class="edit-value content">{$form.$relN.html}</div>
                                    </td>
                                  </tr>
                                   {/if} 
                                   {assign var="count" value="1"}
