...
class CRM_Contribute_Form_Contribution_Confirm extends CRM_Contribute_Form_ContributionBase {
  ...
  public function preProcess() {
    ...
    if ($this->_contributeMode == 'express') {
      ...
      if (isset($this->_params['amount'])) {
        // if (isset($this->_params['custom_27'])) {
        //   $this->_params['amount'] = $this->_params['amount'] * $this->_params['custom_27'];
                
        //   foreach ($this->_lineItem[$this->_priceSetId] AS $lineItemId => $lineItem) {
        //     $this->_lineItem[$this->_priceSetId][$lineItemId]['qty'] = $this->_params['custom_27'];
        //     $this->_lineItem[$this->_priceSetId][$lineItemId]['line_total'] = $lineItem['unit_price'] * $this->_params['custom_27'];
        //   }
        // }
  ...
  static function processContribution(&$form,
    ...
    CRM_Core_Error::debug('contribParams',$contribParams);
